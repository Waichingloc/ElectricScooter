<template>
  <div class="container">
    <div class="row">
      ...
      <div v-if="selectedScooter" class="col-md-6">
        <ScootersDetail32 @delete="deleteScooter"
                       :selectedScooter="getCurrentScooter()">
        </ScootersDetail32>
      </div>
      <div v-else class="col-md-6 scooter-overview-detail mt-5">
        Click on a stock for more details
      </div>
    </div>
    <div class="">
...
import ScootersDetail32 from "@/components/scooters/ScootersDetail32.vue";
import {ref} from "vue";
